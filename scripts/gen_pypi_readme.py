...
rewriting every relative target to an absolute, version-tagged GitHub URL:
    ...
    ![...](docs/images/x.png)
        -> https://raw.githubusercontent.com/crftwr/puikit/v1.0.5/docs/images/x.png
    [...](docs/README.md)
...
BLOB_BASE = "https://github.com/crftwr/puikit/blob"
RAW_BASE = "https://raw.githubusercontent.com/crftwr/puikit"
